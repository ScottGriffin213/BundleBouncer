...
namespace BundleBouncer.Shitlist
{
    ...
    public class ShitlistProvider : IShitListProvider
    {
        public ShitlistProvider() {
            Logging.Info("BundleBouncer definitions - Generated @ 2022-02-05T21:56:36.417459:");
        ...
        bool IShitListProvider.IsAssetBundleHashBlacklisted(byte[] digest)
        {
                if (digest[0] == 85)
                {
...
return avID[0] == 'd' && avID[1] == 'f' && avID[2] == 'g' && avID[3] == 'd' && avID[4] == 'f' && avID[5] == 'g' && avID[6] == 'd' && avID[7] == 'g' && avID[8] == 'd' && avID[9] == 'f';
        ...
        bool IShitListProvider.IsAssetBundleHashWhitelisted(byte[] digest)
        {
